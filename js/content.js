window.AgroRadarContent = {
  categorias: [
    {
      slug: "mercado",
      nome: "Mercado",
      descricao: "Preço, câmbio, prêmio, compra e venda no ritmo do agro."
    },
    {
      slug: "clima",
      nome: "Clima",
      descricao: "Janela operacional, chuva, solo e risco para cada praça."
    },
    {
      slug: "pecuaria",
      nome: "Pecuária",
      descricao: "Escala, arroba, nutrição e manejo com leitura regional."
    },
    {
      slug: "logistica",
      nome: "Logística",
      descricao: "Portos, corredores, frete e gargalos que mexem com margem."
    },
    {
      slug: "politica",
      nome: "Política",
      descricao: "Crédito, seguro, infraestrutura e decisões públicas para o campo."
    },
    {
      slug: "tecnologia",
      nome: "Tecnologia",
      descricao: "Ferramentas, rastreabilidade e eficiência na operação."
    }
  ],
  homepage: {
    hero: "corredor-norte-soja-frete-barcarena",
    destaques: [
  ...
  artigos: [
    {
      ...
      categoria: "mercado",
      editoria: "Mercado & Logística",
      titulo: "Corredor Norte ganha tração com soja represada e reabre disputa por frete entre Miritituba e Barcarena",
      resumo: "O corredor Barcarena-Miritituba voltou ao centro da operação comercial, com produtor mais seletivo, prêmio firme e disputa logística em lotes curtos.",
      chamada: "Tradings, cooperativas e transportadores relatam nova pressão sobre o frete à medida que o fluxo de soja se reorganiza no Norte.",
      imagem: "assets/logistica.svg",
      data: "2026-04-15T09:20:00-03:00",
      local: "Belém (PA)",
      tempoLeitura: "6 min",
      destaques: [
    ...
    },
    {
      ...
      categoria: "clima",
      editoria: "Clima",
      titulo: "Sul do Pará ganha nova janela de umidade e melhora a leitura operacional para milho e manejo de solo",
      resumo: "A nova rodada de chuva não resolve tudo, mas devolve previsibilidade para quem precisava reorganizar manejo e pulverização.",
      chamada: "Modelos apontam chuva distribuída e redução do estresse hídrico em áreas que vinham operando com margem curta.",
      imagem: "assets/clima.svg",
      data: "2026-04-15T08:40:00-03:00",
      local: "Redenção (PA)",
      tempoLeitura: "4 min",
      destaques: [
    ...
    },
    {
      ...
      categoria: "mercado",
      editoria: "Mercado",
      titulo: "Santarém volta ao radar com prêmio mais firme e origem seletiva para soja disponível",
      resumo: "O prêmio melhora, porém não basta sozinho: produtor continua filtrando oportunidades de venda.",
      chamada: "O apetite por origem no porto cresce, mas a negociação segue pontual e depende de margem logística bem calibrada.",
      imagem: "assets/logistica.svg",
      data: "2026-04-15T09:00:00-03:00",
      local: "Santarém (PA)",
      tempoLeitura: "5 min",
      destaques: [
    ...
    },
    {
      ...
      categoria: "pecuaria",
      editoria: "Pecuária",
      titulo: "Escalas mais curtas em Rondônia deixam frigoríficos mais sensíveis ao ritmo de oferta",
      resumo: "O mercado do boi em Rondônia ganha firmeza quando a oferta some da tela e as escalas encurtam.",
      chamada: "A praça opera com compra mais atenta, retenção moderada e necessidade maior de cobertura rápida.",
      imagem: "assets/pecuaria.svg",
      data: "2026-04-15T08:55:00-03:00",
    ...
    },
    {
      ...
      categoria: "politica",
      editoria: "Política",
      titulo: "Crédito e seguro rural voltam ao centro da conversa no Tocantins com produtor mais cauteloso",
      resumo: "No Tocantins, a decisão financeira pesa tanto quanto a operacional na preparação da próxima safra.",
      chamada: "A busca por previsibilidade financeira cresce num ambiente de custos altos e compra mais seletiva.",
      imagem: "assets/politica.svg",
      data: "2026-04-15T08:25:00-03:00",
      local: "Palmas (TO)",
      tempoLeitura: "4 min",
      destaques: [
    ...
    },
    {
      ...
      editoria: "Tecnologia",
      titulo: "Rastreabilidade de rebanho avança em Rondônia como resposta a mercado mais exigente",
      resumo: "A tecnologia avança quando resolve venda, manejo e confiança comercial ao mesmo tempo.",
      chamada: "Ferramentas simples de gestão e coleta de dados começam a sair do discurso e entrar na rotina da fazenda.",
      imagem: "assets/tecnologia.svg",
      data: "2026-04-15T07:50:00-03:00",
      local: "Ji-Paraná (RO)",
      tempoLeitura: "4 min",
      destaques: [
    ...
    },
    {
      ...
      categoria: "pecuaria",
      editoria: "Pecuária",
      titulo: "Piscicultura no Amazonas recalcula margem com ração cara e logística ainda irregular",
      resumo: "A pressão da ração continua sendo o ponto central para a sustentabilidade econômica da atividade.",
      chamada: "O produtor regional busca eficiência operacional enquanto tenta proteger caixa diante do custo mais alto.",
      imagem: "assets/pecuaria.svg",
      data: "2026-04-15T08:05:00-03:00",
      local: "Manaus (AM)",
      tempoLeitura: "4 min",
      destaques: [
    ...
    },
    {
      ...
      categoria: "mercado",
      editoria: "Mercado",
      titulo: "Café robusta da fronteira Norte busca nova rota de venda com produtor mais atento ao câmbio",
      resumo: "O robusta da região ganha interesse, mas a decisão comercial segue muito dependente do custo para escoar.",
      chamada: "A leitura de mercado incorpora logística, câmbio e oportunidade comercial em vez de apenas preço nominal.",
      imagem: "assets/mercado.svg",
      data: "2026-04-15T07:35:00-03:00",
      local: "Rio Branco (AC)",
      tempoLeitura: "4 min",
      destaques: [
    ...
    },
    {
      ...
      categoria: "mercado",
      editoria: "Mercado",
      titulo: "Cacau da Transamazônica ganha tração com indústria local e produtor mais atento à qualidade",
      resumo: "A competitividade cresce quando qualidade e organização comercial avançam juntas.",
      chamada: "A origem regional tenta capturar mais valor combinando padronização, relacionamento comercial e identidade de praça.",
      imagem: "assets/mercado.svg",
      data: "2026-04-15T07:20:00-03:00",
      local: "Altamira (PA)",
      tempoLeitura: "4 min",
      destaques: [
    ...
    },
    {
      ...
      categoria: "tecnologia",
      editoria: "Tecnologia",
      titulo: "Cooperativas do Pará ampliam teste de bioinsumos para reduzir dependência de compra de última hora",
      resumo: "Bioinsumo ganha espaço quando entra como ferramenta de planejamento e não como moda.",
      chamada: "A adoção ainda é seletiva, mas cresce nas fazendas que querem previsibilidade maior de custo e manejo.",
      imagem: "assets/tecnologia.svg",
      data: "2026-04-15T07:10:00-03:00",
      local: "Castanhal (PA)",
      tempoLeitura: "4 min",
      destaques: [
